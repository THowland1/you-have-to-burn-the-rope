...
type ITopLeftBottomRight = Record<'top' | 'left' | 'bottom' | 'right', number>;
type ITopBottomRight = Record<'top' | 'bottom' | 'right', number>;
type ITopLeftBottom = Record<'top' | 'left' | 'bottom', number>;
type ITopLeftRight = Record<'top' | 'left' | 'right', number>;
type ILeftBottomRight = Record<'left' | 'bottom' | 'right', number>;
class Platform extends Coordinates {
  constructor({ left, top, right, bottom }: ITopLeftBottomRight) {
