...
},{"./helpers/bundle-url":"lgJ39"}],"jvo1K":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('7CghF') + "index.html" + "?" + Date.now();
