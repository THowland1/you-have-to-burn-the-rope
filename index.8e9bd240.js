...
*/ var OVERLAY_ID = '__parcel__error__overlay__';
        ...
        if ('serviceWorker' in navigator) window.addEventListener('load', () => {
            navigator.serviceWorker.register(require("74b04c12ea95af8b")).then((reg) => console.log('Success: ', reg.scope)
    ...
    }, { "./js/axes.js": "3Mg37", "./js/boss.js": "bFf1O", "./js/canvas.js": "13tVG", "./js/chandelier.js": "bkAY2", "./js/consts.js": "fWdKl", "./js/coordinates.js": "6LQZI", "./js/debug-menu.js": "iniOa", "./js/explosions.js": "3K9Vs", "./js/flames.js": "9HgUM", "./js/healthbar.js": "eblPy", "./js/lasers.js": "03zEE", "./js/phase-manager.js": "1vKeu", "./js/platforms.js": "gxePh", "./js/player.js": "fBCT6", "./js/plumes.js": "hc3pz", "./js/rope.js": "chIhe", "./js/slides.js": "dwqLw", "./js/time-manager.js": "hcjEB", "./js/audio-manager.js": "eHiBI", "./js/button-manager.js": "kCO8j", "74b04c12ea95af8b": "99U6s" }], "3Mg37": [function (require, module, exports) {
        ...
        const axeImg = img('./img/axe_18x18.png');
        class Axes {
            constructor() {
        /** @type {Axe[]} */ this.axes = [];
            }
    ...
    }, { "./coordinates.js": "6LQZI", "./canvas.js": "13tVG", "./boss.js": "bFf1O", "./healthbar.js": "eblPy", "./time-manager.js": "hcjEB", "./audio-manager.js": "eHiBI", "./consts.js": "fWdKl", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "6LQZI": [function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
     ...
     */ constructor() {
        ...
        /** @type{'move' | 'attack' | 'still'} */ this.mode = 'attack';
                ...
                this.images = {
                    attack: img('./img/boss-attack_204x256.png'),
                    die: img('./img/boss-die_192x256.png'),
                    lookup: img('./img/boss-lookup_192x256.png'),
                    move: img('./img/boss-move_204x256.png'),
                    still: img('./img/boss-still_204x256.png')
                };
                this.lastAttacked = 0;
            ...
            draw() {
                let img1;
                this.width = 204;
                img1 = this.images.move;
                if (_phaseManagerJs.phaseManager.phase === _phaseManagerJs.PHASES.bossdying) {
                    this.width = 192;
                    img1 = this.images.die;
                } else if (this.mode === 'attack') img1 = this.images.attack;
                else if (this.mode === 'still') img1 = this.images.still;
                else if (this.top > _playerJs.player.bottom) {
                    this.width = 192;
                    img1 = this.images.lookup;
                }
                if (this.facingRight) _canvasJs.c.drawImage(img1, this.localLeft, this.localTop, this.width, this.height);
                else {
                    _canvasJs.c.save();
                    _canvasJs.c.scale(-1, 1);
                    _canvasJs.c.drawImage(img1, -1 * this.localRight, this.localTop, this.width, this.height);
                    _canvasJs.c.restore();
                }
            }
            update() {
    ...
    }, { "./canvas.js": "13tVG", "./consts.js": "fWdKl", "./coordinates.js": "6LQZI", "./player.js": "fBCT6", "./phase-manager.js": "1vKeu", "./lasers.js": "03zEE", "./time-manager.js": "hcjEB", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "fWdKl": [function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        ...
        /** px per frame */ this.velocity = {
                ...
                this.images = {
                    fall: img('./img/player-fall_30x36.png'),
                    hit: img('./img/player-hit_30x36.png'),
                    jump: img('./img/player-jump_30x36.png'),
                    still: img('./img/player-still_30x36.png'),
                    throw: img('./img/player-throw_30x36.png'),
                    walk1: img('./img/player-walk-1_30x36.png'),
                    walk2: img('./img/player-walk-2_30x36.png'),
                    walk3: img('./img/player-walk-3_30x36.png'),
                    stick: img('./img/stick_30x6.png'),
                    flame1: img('./img/flame-1_28x28.png'),
                    flame2: img('./img/flame-2_28x28.png'),
                    flame3: img('./img/flame-3_28x28.png')
                };
            ...
            draw() {
                ...
                let img1;
                if (this.flying) img1 = this.images.hit;
                else if (_timeManagerJs.timeManager.now - this.lastAttack < 100) img1 = this.images.throw;
                else if (this.velocity.y > 0) {
                    img1 = this.images.fall;
                    torchOffset.x = 1;
                    torchOffset.y = -6;
                } else if (this.velocity.y < 0) {
                    img1 = this.images.jump;
                    torchOffset.x = 1;
                } else if (this.velocity.x !== 0) {
                    img1 = this.walkFrames.get();
                    torchOffset.x = 1;
                } else img1 = this.images.still;
                if (this.blinking) {
                    const sinceHit = _timeManagerJs.timeManager.now - this.lastHit;
                    if (sinceHit % 500 > 300) return;
                }
                if (this.facingRight) {
                    _canvasJs.c.drawImage(img1, this.localLeft, this.localTop, this.width, this.height);
                    if (this.hasFlame) {
        ...
        class EndCreditsMusic {
            constructor() {
                this.audio = new Audio('./audio/now-youre-a-hero.mp3');
                this.startTime = null;
            }
            play() {
                this.startTime = new Date().valueOf();
        ...
        class AudioManager {
            constructor() {
                this.volume = 1;
                this.tunnelMusic = new Audio('./audio/tunnel.mp3');
                this.tunnelMusic.loop = true;
                this.tunnelMusic.volume = this.volume;
                this.bossFightMusic = new Audio('./audio/boss-fight.mp3');
                this.bossFightMusic.loop = true;
                this.bossFightMusic.volume = this.volume;
                this.axeThrowSound = new SFX('./audio/axe-throw.mp3');
                this.ropeExplosionSound = new SFX('./audio/rope-explosion.mp3');
                this.bossExplosionSound = new SFX('./audio/boss-explosion.mp3');
                this.doorSlamSound = new SFX('./audio/door-slam.mp3');
                this.laserSound = new SFX('./audio/eye-laser.mp3');
                this.deathSound = new SFX('./audio/death.mp3');
                this.jumpSound = new SFX('./audio/jump.mp3');
                this.landSound = new SFX('./audio/land.mp3');
    ...
    }, { "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "9HgUM": [function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
    ...
    }, { "./coordinates.js": "6LQZI", "./time-manager.js": "hcjEB", "./canvas.js": "13tVG", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "hcjEB": [function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        ...
        class PhaseManager {
            constructor() {
                this.backDoorImage = img('./img/back-door_32x64.png');
    ...
    }, { "./healthbar.js": "eblPy", "./platforms.js": "gxePh", "./explosions.js": "3K9Vs", "./canvas.js": "13tVG", "./coordinates.js": "6LQZI", "./chandelier.js": "bkAY2", "./rope.js": "chIhe", "./audio-manager.js": "eHiBI", "./button-manager.js": "kCO8j", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "eblPy": [function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        ...
        const explosionImages = [
            img('./img/explosion-1_36x36.png'),
            img('./img/explosion-2_36x36.png'),
            img('./img/explosion-3_36x36.png'),
            img('./img/explosion-4_36x36.png'),
            img('./img/explosion-5_36x36.png'),
            img('./img/explosion-6_36x36.png'),
            img('./img/explosion-7_36x36.png'),
        ];
        class Explosions {
            constructor() {
    ...
    }, { "./coordinates.js": "6LQZI", "./canvas.js": "13tVG", "./frames.js": "atydd", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "bkAY2": [function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        ...
        class Chandelier extends _coordinatesJs.Coordinates {
            constructor() {
                ...
                this.img = new Image();
                this.img.src = './img/chandelier_160x96.png';
                this.show = true;
                this.dropped = false;
                this.velocity = {
                    y: 0
    ...
    }, { "./coordinates.js": "6LQZI", "./canvas.js": "13tVG", "./consts.js": "fWdKl", "./time-manager.js": "hcjEB", "./phase-manager.js": "1vKeu", "./boss.js": "bFf1O", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "chIhe": [function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        ...
        class Rope extends _coordinatesJs.Coordinates {
            constructor() {
                ...
                this.img = new Image();
                this.img.src = './img/rope_8x192.png';
                this.show = true;
    ...
    }, { "./coordinates.js": "6LQZI", "./canvas.js": "13tVG", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "kCO8j": [function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        ...
        const plumeImages = [
            img('./img/plume-1_43x21.png'),
            img('./img/plume-2_43x21.png'),
            img('./img/plume-3_43x21.png'),
            img('./img/plume-4_43x21.png'),
            img('./img/plume-5_43x21.png'),
            img('./img/plume-6_43x21.png'),
        ];
        class Plumes {
            constructor() {
    ...
    }, { "./coordinates.js": "6LQZI", "./frames.js": "atydd", "./audio-manager.js": "eHiBI", "./canvas.js": "13tVG", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "03zEE": [function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
        ...
        const laserImages = [
            img('./img/laser-1_20x20.png'),
            img('./img/laser-2_20x20.png'),
            img('./img/laser-3_20x20.png'),
            img('./img/laser-4_20x20.png'),
            img('./img/laser-5_20x20.png'),
            img('./img/laser-6_20x20.png'),
            img('./img/laser-7_20x20.png'),
        ];
        class Lasers {
            constructor() {
    ...
    }, { "./coordinates.js": "6LQZI", "./canvas.js": "13tVG", "./frames.js": "atydd", "./time-manager.js": "hcjEB", "./audio-manager.js": "eHiBI", "./consts.js": "fWdKl", "./player.js": "fBCT6", "./explosions.js": "3K9Vs", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "iniOa": [function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        parcelHelpers.defineInteropFlag(exports);
    ...
    }, { "./audio-manager.js": "eHiBI", "./canvas.js": "13tVG", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" }], "99U6s": [function (require, module, exports) {
        module.exports = require('./helpers/bundle-url').getBundleURL('ao0Rz') + "up_/serviceworker.js" + "?" + Date.now();
...
}, ["bk4o9", "1jwFz"], "1jwFz", "parcelRequiref536");
